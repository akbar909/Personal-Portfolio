      ...
      <div className='flex flex-col justify-between md:flex-row gap-4 items-center'>
          ...
          <div className='flex items-center gap-4'>
            ...
            >
              <Link
                ...
                smooth
                duration={500}
                className="group flex items-center text-[#FCF6F5FF] w-fit px-6 py-3 rounded-lg bg-gradient-to-r from-[#E94B3CFF] to-[#2D2926FF] cursor-pointer"
              >
                Portfolio
        ...
        <div>
          <img
            ...
            src={hero}
            alt='HeroImage'
            className='rounded-2xl mb-8 md:mt-20 lg:mt-28 md:w-[300px] md:h-[340px] lg:w-[330px] lg:h-[400px]'
          />
        </div>
      </div>
    </div>
